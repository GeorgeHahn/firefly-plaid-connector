...
namespace FireflyIII.Net.Test
{
    ...
    public class UsersApiTests : IDisposable
    {
        ...
        public void ListUserTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? page = null;
            //var response = instance.ListUser(page);
            //Assert.IsType<UserArray> (response, "response is UserArray");
        }
        ...
        public void StoreUserTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //User user = null;
            //var response = instance.StoreUser(user);
            //Assert.IsType<UserSingle> (response, "response is UserSingle");
        }
        ...
        public void UpdateUserTest()
        {
            ...
            //int id = null;
            //User user = null;
            //var response = instance.UpdateUser(id, user);
            //Assert.IsType<UserSingle> (response, "response is UserSingle");
        }
