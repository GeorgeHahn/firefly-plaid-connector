...
namespace FireflyIII.Net.Model
{
    ...
    public partial class LinkTypeRead :  IEquatable<LinkTypeRead>, IValidatableObject
    {
        ...
        public LinkTypeRead(string type = default(string), int id = default(int), LinkType attributes = default(LinkType), ObjectLink links = default(ObjectLink))
        {
            this.Type = type;
            this.Id = id;
        ...
        {
            return this.Equals(input as LinkTypeRead);
        }
