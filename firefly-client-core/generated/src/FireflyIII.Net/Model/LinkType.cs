...
namespace FireflyIII.Net.Model
{
    ...
    public partial class LinkType :  IEquatable<LinkType>, IValidatableObject
    {
        ...
        public LinkType(string name = default(string), string inward = default(string), string outward = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for LinkType and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (inward == null)
            {
                throw new InvalidDataException("inward is a required property for LinkType and cannot be null");
            }
            else
            {
                this.Inward = inward;
            ...
            if (outward == null)
            {
                throw new InvalidDataException("outward is a required property for LinkType and cannot be null");
            }
            else
            {
