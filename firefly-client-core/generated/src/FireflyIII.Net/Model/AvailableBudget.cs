...
namespace FireflyIII.Net.Model
{
    ...
    public partial class AvailableBudget :  IEquatable<AvailableBudget>, IValidatableObject
    {
        ...
        public AvailableBudget(int currencyId = default(int), string currencyCode = default(string), double amount = default(double), DateTime start = default(DateTime), DateTime end = default(DateTime))
        {
            ...
            if (start == null)
            {
                throw new InvalidDataException("start is a required property for AvailableBudget and cannot be null");
            }
            else
            {
                this.Start = start;
            ...
            if (end == null)
            {
                throw new InvalidDataException("end is a required property for AvailableBudget and cannot be null");
            }
            else
            {
                this.End = end;
