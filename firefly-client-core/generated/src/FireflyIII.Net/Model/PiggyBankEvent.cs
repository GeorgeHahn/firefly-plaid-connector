...
namespace FireflyIII.Net.Model
{
    ...
    public partial class PiggyBankEvent :  IEquatable<PiggyBankEvent>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="type">Immutable value indicating the object type..</param>
        /// <param name="id">id.</param>
        /// <param name="attributes">attributes.</param>
        /// <param name="links">links.</param>
        public PiggyBankEvent(string type = default(string), int id = default(int), PiggyBankEventAttributes attributes = default(PiggyBankEventAttributes), ObjectLink links = default(ObjectLink))
        {
            this.Type = type;
            this.Id = id;
        ...
        /// </summary>
        /// <value>Immutable value indicating the object type.</value>
        ...
        public PiggyBankEventAttributes Attributes { get; set; }
