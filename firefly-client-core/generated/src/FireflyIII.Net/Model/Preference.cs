...
namespace FireflyIII.Net.Model
{
    ...
    public partial class Preference :  IEquatable<Preference>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Preference" /> class.
        /// </summary>
        /// <param name="data">This field can also be an array (required).</param>
        public Preference(string data = default(string))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for Preference and cannot be null");
            }
            else
            {
                this.Data = data;
